...
document.addEventListener("DOMContentLoaded", function () {
	...
	document.getElementById('search-input').addEventListener('input', function (e) {
		...
		var filteredData = fullTransactionData.filter(function (transaction) {
			var foundInName = transaction.name.toUpperCase().indexOf(searchString) > -1;
			var foundInFor = transaction.for.toUpperCase().indexOf(searchString) > -1;
			var foundInDate = transaction.date.toUpperCase().indexOf(searchString) > -1;
			var foundInAmount = transaction.amount.toUpperCase().indexOf(searchString) > -1;
